package top.testeru.mini.config;
...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("mini系统")// 页面标题
                .description("mini接口文档")// 描述
                .contact(new Contact("testeru", "https://github.com/TesterDevSoul/TesteruBlog", "iisfenggai@gmail.com"))// 创建人信息
...
//                .apis(RequestHandlerSelectors.any())
                .apis(RequestHandlerSelectors.basePackage("top.testeru.mini"))
